    ...
    <main className='bg-black'>
      ...
      <div className='flex flex-col gap-5 justify-center items-center m-4 font-bold'>
        <span className='flex items-center justify-center md:w-2/4'>
          <p>
            Olá! Meu nome é Daniel, trabalho com o marketing digital. Desde que comecei a
            estudar o assunto, há cerca de 4 anos, sempre gostei muito da ideia de ser meu
            próprio chefe e não ter que trabalhar sempre no mesmo lugar.
          </p>
        </span>
        <span className='flex items-center justify-center md:w-2/4'>
          <p>
            Investi muito tempo para aprender e aprimorar minhas habilidades em marketing
            digital. Foi um processo desafiador, mas muito gratificante, que me me permitiu
            descobrir os segredos e mistérios desse universo.
          </p>
        </span>
        <span className='flex items-center justify-center md:w-2/4'>
          <p>
            Hoje, sinto que tenho um bom conhecimento para compartilhar e pretendo.
            ajudar outras pessoas a entender e utilizar o marketing digital em suas vidas
            e negócios. Por isso, quero repassar a informação da forma mais barata possível,
            para que todos possam ter acesso a esse conhecimento valioso.
          </p>
        </span>
      </div>
      ...
      <div className='flex'>
        <footer className='flex justify-start items-start ml-5'>Políticas de privacidade</footer>
        <footer className='flex justify-end items-end ml-auto pr-6'>Políticas de privacidade</footer>
      </div>
    </main>
  )
}
